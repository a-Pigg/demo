...
export default {
  ...
  computed: {
    ...
    billsColums() {
      ...
      columns.push({
        prop: "count",
        label: this.$i18n.t("h.totalAssets"),
        fixed: false,
    ...
    getAssetDeptBills() {
      ...
      select({
        ...
        .then(({ data }) => {
          ...
          this.assetDeptBills = transListDataToTreeData(data.data[2], null);
        })
        .catch(() => {
          this.tableLoading = false;
          this.assetDeptBills = [];
